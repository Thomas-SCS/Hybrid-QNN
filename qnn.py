"""
ALL CODE TAKEN FROM https://nvidia.github.io/cuda-quantum/0.8.0/examples/python/tutorials/hybrid_qnns.html
"""
...
x_train, x_test, y_train, y_test = prepare_data(target_digits, sample_count,
                                                test_size)
# %% =========================================================================
# IMPLEMENT QUANTUM PORTION OF NETWORK
# ================
